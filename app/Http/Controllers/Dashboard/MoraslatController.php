    ...
    public function show_history(Request $request)
    {
        if (Perm::get_function_access(54)) {
            ...
            $moraslat_history = DB::table('moraslat_history')
                 ->join('moraslat', 'moraslat_history.moraslat_id', '=', 'moraslat.moraslat_id')
                 ->leftJoin('users as xx', 'moraslat.user_id', '=', 'xx.id')
                ...
                ->select('moraslat_history.*', 'users.name as emp_name', 'moraslat_status.moraslat_status_name', 'xx.name as create_name', 'moraslat.moraslat_respon')
