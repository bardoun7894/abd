...
class FinancialController extends Controller
{
    ...
    public function views()
    {
        ...
        $page_title = 'إدارة مصاريف العمال';
        return view('dashboard.financial.view', compact('work_place', 'manager', 'page_title', 'nowmonth'));
        } else {
            return redirect()->route('show_not_allow')->send();
        }
    }
    ...
    public function ajax_search_financial(Request $request)
    {
        ...
        $list_totl = Financial::sumspendcountdesc($financial_month_m, $financial_month_y, $worker_id, $manager_id,$from , $to);
        ...
        $list_total = Financial::serachspendcountdesc($financial_month_m, $financial_month_y, $worker_id, $manager_id,$from,$to);
        $list = Financial::serachspenddatadesc($financial_month_m, $financial_month_y, $worker_id, $manager_id,$from,$to);
...
if(!$payments_month_val){$payments_month_val=500;}
        ...
        return redirect()->route('dashboard.financial.views');
