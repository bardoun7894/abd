...
<head><base href="../../">
<title>نظام إدارة الشركة - @yield('title','لوحة التحكم')</title>
<meta name="description" content="نظام إدارة الشركة" />
<meta name="keywords" content="" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="csrf-token" content="{{ csrf_token() }}">
<meta charset="utf-8" />
<meta property="og:locale:alternate" content="ar_SA" />
<meta property="og:type" content="نظام إدارة الشركة" />
<meta property="og:title" content="نظام إدارة الشركة" />
            ...
            <div id="kt_header" style="" class="header align-items-stretch">
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                        ...
                        <!-- <span class="badge badge-light-success fw-bolder fs-8 px-2 py-2 ms-2">@auth(){{Auth::user()->role_id != null ? Auth::user()->role->name :'اهلا '}} @else Employee @endauth</span>-->
                        </div>
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-8">@auth(){{Auth::user()->name}} @else User Name @endauth
                                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">@auth(){{Auth::user()->role_id != null ? Auth::user()->role->name :'اهلا'}} @else Employee @endauth</span>
                                                    </div>
                                        ...
                                        <div class="menu-item px-5">
                                            ...
                                            <form method="post" action="{{route('logout')}}">
                                                ...
                                                <button type="submit" class="menu-link px-5">
                                                  <i class="fa-regular fa-right-from-bracket fs-4">تسجيل الخروج
                                                </i>
                                                </button>
                                              </form>
                                            </div>-->
                ...
                <div class="toolbar" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        ...
                        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0" style='background-color: #083da6;' >
                            ...
                            <h1 class="d-flex align-items-center text-light  fs-8 my-1">@yield('sub',"نظام إدارة الشركة")</h1>
                            <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    <div class="text-dark order-2 order-md-1">
                        <a href="#" target="_blank" class=" text-hover-primary fw-bolder text-dark">تم التطوير بواسطة دائرة الحاسوب - نظام إدارة الشركة</a>
