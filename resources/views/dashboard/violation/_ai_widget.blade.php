...
.ai-result-box{border:1px dashed rgba(20,119,174,.35);border-radius:.75rem;padding:1rem 1.1rem;background:rgba(20,119,174,.04);}
.ai-result-box .alert{border-inline-start:4px solid var(--sn-emerald-deep);border-radius:.6rem;}
