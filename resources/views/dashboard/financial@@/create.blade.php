...
@section('content')
    ...
    <form id="save_paymentsmonth" name="save_paymentsmonth" class="form" action="{{ route('dashboard.accountings.storepmonth') }}"
                ...
                <div class="card">
                    <div class="card-body px-1">
                        <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6"
                            id="errorBox_paymentsmonth" style="display: none !important">
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                            ...
                                            type="text" name="payments_month_val" id="payments_month_val"
