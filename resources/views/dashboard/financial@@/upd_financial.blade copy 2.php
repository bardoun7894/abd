...
<form id="upd_financial_data" name="upd_financial_data" class="form" action="{{ route('dashboard.financial.updstore') }}"
    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
            ...
            <div class="card">
                <div class="card-body ">
                    <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6" id="errorBox_financial"  style="display: none !important">
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5">
                            ...
                            <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5">
                                <label for="worker_id" class="form-label required fs-6 fw-bold text-dark mb-3">اسم المحل</label>
                                <div>
                                    <select class="form-select fw-bolder  worker_id  " id="worker_id" onchange='sel_worker_pay()'
                                        name="worker_id" dir="rtl" data-placeholder="اسم المحل">
                                        <option value="">اختر ..</option>
                                        <option @selected($financial->worker_id==$worker->worker_id) value="{{ $worker->worker_id }}">{{ $worker->worker_name}}</option>
                            ...
                            <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        type="text" name="financial_month_desc" id="financial_month_desc" value="{{ $financial->financial_month_desc }}"
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        type="text" name="financial_month_val" id="financial_month_val"
                            ...
                            <div class=" col-12 col-lg-4 col-md-12 col-sm-12  mb-5">
                                ...
                                <textarea name="note" class="form-control fw-bold" id="note" placeholder="ملاحظة">{{ $financial->note }}</textarea>
                            </div>
                        </div>
                        <!--end::Row-->
                        <!--begin::Actions-->
