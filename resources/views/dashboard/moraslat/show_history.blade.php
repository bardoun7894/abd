                                 ...
                                 if (isset($moraslat_history)) {
                                     ...
                                     if ($z != 0) {
                                         ...
                                         foreach ($moraslat_history as $x) {
                                             ...
                                             $create_name = $x->create_name;
                                             $moraslat_respon = $x->moraslat_respon;
                                             ...
                                             <tr>
                                                 ...
                                                 <td  style="text-align: center;"> <?php echo $create_name ?></td>
                                                 <td  style="text-align: center;"> <?php echo $moraslat_status_name ?></td>
                                                 <td  style="text-align: center;"> <?php echo $moraslat_respon ?></td>
