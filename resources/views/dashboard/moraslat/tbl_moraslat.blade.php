...
<script src="{{ asset('assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
   <div class="py-5">
        <table id="moraslat_tbl" class="table table-row-bordered gy-5 sn-thead">
        	<thead>
...
var moraslat_status_id = $('#moraslat_status_id_v').val();
            ...
            "ajax": {
              url: url,
                ...
                data: function (d) {
                 ...
                 d.moraslat_status_id = moraslat_status_id;
