                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="fw-bold mb-0">بحث في سجل المراسلات</h3>
                        </div>
                    </div>
                    <div class="card-body px-1">
                        ...
                        <div id="result_moraslat_tbl" name="result_moraslat_tbl" class="mor-log-results">
                        </div>
                    </div>
                </div>
            </div>
...
@section('styles')
    <style>
        /* -------------------------------------------------------------------
           Correspondence (moraslat) list — restyled to match
           resources/views/dashboard/purchase/view.blade.php's emerald
           redesign (itself matching invoices/index.blade.php's
           "سجل عمليات الاستخراج" look). Scoped entirely under .mor-log so
           nothing leaks to other pages. Reuses the --sn-* brand tokens
           already defined in public/css/app-ui.css (not touched —
           page-scoped override, same approach as the purchases redesign).

           #moraslat_tbl is loaded via AJAX (view_all_moraslat() -> tbl())
           and injected into #result_moraslat_tbl, which lives inside
           .mor-log — so these selectors reach the AJAX-injected table too,
        ...
        /* ---- table header: solid emerald fill, white bold text -------------
               ...
               (app-ui.css §6) on purpose, matching the purchases page. ------ */
        .mor-log #moraslat_tbl.sn-thead thead tr,
        .mor-log #moraslat_tbl thead.sn-thead tr {
            background: var(--sn-emerald) !important;
            color: #fff !important;
        }
        .mor-log #moraslat_tbl.sn-thead thead th,
        .mor-log #moraslat_tbl thead.sn-thead th {
            color: #fff !important;
            font-weight: 700;
        ...
        .mor-log #moraslat_tbl td {
            color: var(--sn-ink);
        }
        .mor-log #moraslat_tbl .text-muted {
        ...
        .mor-log #moraslat_tbl tbody tr:hover {
        ...
        .mor-log #moraslat_tbl tbody tr:nth-child(1)  { animation-delay: 0ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(2)  { animation-delay: 30ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(3)  { animation-delay: 60ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(4)  { animation-delay: 90ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(5)  { animation-delay: 120ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(6)  { animation-delay: 150ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(7)  { animation-delay: 180ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(8)  { animation-delay: 210ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(9)  { animation-delay: 240ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(10) { animation-delay: 270ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(11) { animation-delay: 300ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(12) { animation-delay: 330ms; }
        .mor-log #moraslat_tbl tbody tr:nth-child(n+13) { animation-delay: 350ms; }
