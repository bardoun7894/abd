...
@section('content')
    ...
    <form id="save_moraslat" name="save_moraslat" class="form" action="{{ route('dashboard.moraslat.store') }}"
                        ...
                        <div class="mb-0">
                            ...
                            <div class="row gx-5 mb-5">
                                <div class="col-12 col-lg-5 col-md-12 col-sm-12 mb-5">
                                    <label for="moraslat_type_id" class="form-label   fs-6 fw-bolder text-danger mb-3">نوع المراسلة</label>
                                    <div>
                                        <select class="form-select fw-bolder text-danger moraslat_type_id " data-control="select2" id="moraslat_type_id"
                                            name="moraslat_type_id" dir="rtl" onchange='load_moraslat_form(this.value,1)'   data-url="{{ route('dashboard.moraslat.load_moraslat_form') }}" >
