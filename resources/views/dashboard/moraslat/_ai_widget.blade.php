...
.ai-card--info{border-color:rgba(37,67,93,.18);background:linear-gradient(180deg,rgba(37,67,93,.06) 0%,rgba(255,255,255,0) 65%);}
.ai-card--info::before{background:linear-gradient(180deg,var(--sn-emerald-deep),var(--sn-emerald));}
...
.ai-card--info .ai-icon-badge{background:linear-gradient(135deg,var(--sn-emerald-deep),var(--sn-emerald));box-shadow:0 .35rem .85rem rgba(37,67,93,.35);}
...
.ai-card--info .ai-pill{background:linear-gradient(135deg,var(--sn-emerald-deep),var(--sn-emerald));}
...
{{-- T6-motion: analyzing state class + result-reveal (field flash / check pop / fields chip) + optional
     re-analyze button. Additive — watches the same status elements with a NEW, separate
