                        ...
                        <div class="mb-0">
                            <div class="mb-5 row gx-5">
                                ...
                                {{-- <div class="mb-5 col-12 col-lg-2 col-md-12 col-sm-12">
                                    <label for="calculate_month_desc_v" class="mb-3 form-label required fs-6 fw-bold text-dark">شهر الدفع
                                        :</label>
                                ...
                                <div class="mb-5 col-12 col-lg-4 col-md-12 col-sm-12">
                                    <label for="shop_id_v" class="mb-3 form-label required fs-6 fw-bold text-dark">اسم
                                        المحل</label>
                                    <div>
                                    ...
                                    <div
                                        ...
                                        <div class="px-3 menu-item">
                                            <a data-url='{{ route('dashboard.report.print_calculate_pdf') }}'
                                               onclick="print_calculate_pdf('')" class="px-3 menu-link text-dark print_calculate_pdf"><span><i
                                        ...
                                        <div class="px-3 menu-item">
                                            <a data-url='{{ route('dashboard.report.print_calculate_xlsx') }}'
                                               ...
                                               class="px-3 menu-link text-dark print_calculate_xlsx"><span><i
