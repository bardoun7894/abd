...
<td nobr="true" style="text-align:center;border:1px solid #000000;background-color:#e4dcd6;font-weight: bold;width:8%;">تاريخ الادخال</td>
    ...
    $work_place_id= "";
    $work_place_name= "";
    $calculate_month_val_sum=0;
    $sum_det_calculate_month_pay_sum=0;
    $sum_det_calculate_month_remain_sum=0;
...
<td style="text-align:center;border: 1px solid #000000;">'.$calculate_month_desc.'</td>
<td style="text-align:center;border: 1px solid #000000;">'.$calculate_desc.'</td>
<td style="text-align:center;border: 1px solid #000000;">'.$calculate_month_val.'</td>
<td style="text-align:center;border: 1px solid #000000;">'.$sum_det_calculate_month_pay.'</td>
<td style="text-align:center;border: 1px solid #000000;">'.$sum_det_calculate_month_remain.'</td>
...
<td colspan="3" style="text-align:center;border:1px solid #000000;background-color:#e3f2e4;font-weight:bold;"> الإجمالي المبلغ المتبقي</td>
    ...
    $tbl .= '<tr nobr="true" bordercolor=#666666>
<td colspan="4" style="text-align:center;border:1px solid #000000;font-weight:bold;">'.$calculate_month_val_sum.'</td>
<td colspan="4" style="text-align:center;border:1px solid #000000;font-weight:bold;">'.$sum_det_calculate_month_pay_sum.'</td>
<td colspan="3" style="text-align:center;border:1px solid #000000;font-weight:bold;">'.$sum_det_calculate_month_remain_sum.'</td>
</tr>';
