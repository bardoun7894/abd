...
<form id="upd_vacation_data" name="upd_vacation_data" class="form" action="{{ route('dashboard.vacation.updstore') }}"
    method="post" enctype="multipart/form-data" autocomplete="off">
    @csrf


    <input name="vacation_id_db" id="vacation_id_db" value="{{ $vacation->vacation_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="vacation_id_db"
    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
            ...
            <div class="card">
                <div class="card-body ">
                    <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6" id="errorBox_vacation"  style="display: none !important">
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5">
                            ...
                            <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5">
                                <label for="worker_id" class="form-label required fs-6 fw-bold text-dark mb-3">اسم الموظف</label>
                                <div>
                                    <select class="form-select fw-bolder  worker_id  " id="worker_id"
                                        name="worker_id" dir="rtl" data-placeholder="اسم الموظف">
                                        <option value="">اختر ..</option>
                                        <option @selected($vacation->worker_id==$worker->worker_id) value="{{ $worker->worker_id }}">{{ $worker->worker_name}}</option>
                            ...
                            <div class=" col-12 col-lg-3 col-md-12 col-sm-12  mb-5">
                                ...
                                <label for="moraslat_dt_from" class="  form-label required fs-6 fw-bold text-dark mb-3">تاريخ الاجازة
                                    </label>
                                <div class="input-daterange input-group" id="kt_datepicker">
                                    <input type="text" class="form-control input_date_ "
                                        name="start" id="start" placeholder="من" data-col-index="5" value="{{ $vacation->start }}"
                                        readonly="readonly">
                                    ...
                                    <input type="text" class="form-control input_date_ "
                                        name="end" id="end" placeholder="إلى" data-col-index="5" value="{{ $vacation->end }}"
                                        readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label for="vacation_type_id" class="form-label required  fs-6 fw-bolder  mb-3">نوع الاجازة</label>
                                <div>
                                    <select class="form-select fw-bolder  form-select_u " data-control="select2" id="vacation_type_id"
                                        name="vacation_type_id" dir="rtl"  >
                                        <option value="">اختر ..</option>

                                        @foreach ($vacation_type as $x)
                                            <option  @selected($vacation->vacation_type_id==$x->vacation_type_id) value="{{ $x->vacation_type_id }} ">{{ $x->vacation_type_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="count_day" class="form-label required fs-6 fw-bold text-dark mb-3">عدد الايام</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="count_day" id="count_day"
                                        class="form-control fw-bold text-dark text-info"  value="{{ $vacation->count_day }}"
                            ...
                            <div class=" col-12 col-lg-12 col-md-12 col-sm-12  mb-5">
                                ...
                                <textarea name="note" class="form-control fw-bold" id="note" placeholder="ملاحظة">{{ $vacation->note }}</textarea>
                            </div>
                        </div>
