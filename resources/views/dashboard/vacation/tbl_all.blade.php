...
<script src="{{ asset('assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
   <div class="py-5">
        <table id="vacation_tbl_all" class="table table-row-bordered gy-5">
        	<thead>
    ...
    <script type="text/javascript">
        $(function () {
            var url = "{{ route('dashboard.vacation.ajax_search_vacation_all') }}";
        var save_method;
        var table;
        var vacation_month_desc = $('#vacation_month_desc_v').val();
    var worker_id = $('#worker_id_v').val();
        table = $('#vacation_tbl_all').DataTable({
            "searching": false,
