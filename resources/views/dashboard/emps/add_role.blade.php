...
@section('content')
    ...
    <form id="save_role" name="save_role" class="form" action="{{ route('dashboard.emps.save_role') }}"
                            ...
                            <div class="row gx-5 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        class="form-control fw-bold  text-dark" placeholder=" اسم المجموعة "
    ...
    $('#jstree').on("changed.jstree", function (e, data) {
        ...
        $(function () {
            $('#jstree').jstree({
               ...
               // 'plugins': ["wholerow","checkbox", "types", "search", "changed"],
