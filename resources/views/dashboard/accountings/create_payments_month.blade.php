...
@section('content')
    ...
    <form id="save_payments_month" name="save_payments_month" class="form" action="{{ route('dashboard.accountings.storepmonth') }}"
                            ...
                            <div class="row gx-5 mb-5">
                                ...
                                <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5">
                                    <label for="worker_id" class="form-label required fs-6 fw-bold text-dark mb-3">اسم
                                        العامل</label>
                                    <div>
                                        <select class="form-select fw-boldثق  worker_id  " id="worker_id"
                                ...
                                <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="payments_month" class="form-label required fs-6 fw-bold text-dark mb-3">شهر الدفع
                                        :</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                            type="text" name="payments_month" id="payments_month"
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="payment_req" class="form-label required fs-6 fw-bold text-dark mb-3">المبلغ
                                        </label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                            type="text" name="payment_req" id="payment_req" readonly
