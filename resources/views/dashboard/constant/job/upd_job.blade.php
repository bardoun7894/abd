...
<form id="upd_job_data" name="upd_job_data" class="form" action="{{ route('dashboard.constant.updstorejob') }}"
    method="post" enctype="multipart/form-data" autocomplete="off">
    @csrf


    <input name="job_id_db" id="job_id_db" value="{{ $job->job_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="job_id_db"
            ...
            <div class="card">
                <div class="card-body ">
                    <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6"
                        id="errorBox_job_upd" style="display: none !important">
                        ...
                        <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                            <span id="displayErrors_job_upd" class="mb-2  fw-bolder text-light"></span>
                        </div>
                        <button type="button"
                    ...
                    <div class="alert alert-dismissible bg-success d-flex flex-column flex-sm-row w-100 p-5 mb-6"
                        id="successBox_job" style="display: none !important">
                        <span class="svg-icon svg-icon-2hx svg-icon-light me-4 mb-5 mb-sm-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path opacity="0.3"
                        ...
                        <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                            ...
                            <span id="displaysuccess_job"></span>
                        </div>
                        <button type="button"
                            class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto"
                            data-bs-dismiss="alert">
                    ...
                    <div class="mb-0">
                        ...
                        <div class=" col-12 col-lg-9 col-md-12 col-sm-12 mb-5"><label for="job_name"
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                ...
                                type="text" name="job_name_u" id="job_name_u" value="{{ $job->job_name }}"
