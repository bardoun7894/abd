...
@section('content')
    ...
    <form id="save_calculate" name="save_calculate" class="form" action="{{ route('dashboard.calculate.store') }}"
                ...
                <div class="card">
                    <div class="card-body px-1">
                        <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6"
                            id="errorBox_calculate" style="display: none !important">
                                ...
                                <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                            ...
                                            type="text" name="calculate_month_desc" id="calculate_month_desc"
...
$('#calculate_month_remain').val('');
    ...
    <script type="text/javascript" src="{{ asset('assets/module/calculate_j.js') }}?t={{ config('global.ver.version_all') }}"></script>
