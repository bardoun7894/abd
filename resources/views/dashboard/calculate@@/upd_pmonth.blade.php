...
<form id="upd_payments_data" name="upd_payments_data" class="form" action="{{ route('dashboard.accountings.updpmonthstore') }}"
    method="post" enctype="multipart/form-data" autocomplete="off">
    @csrf


    <input name="payments_month_id_db" id="payments_month_id_db" value="{{ $payments->payments_month_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="payments_month_id_db"
    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
            ...
            <div class="card">
                <div class="card-body ">
                    <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6" id="errorBox_paymentsmonth"  style="display: none !important">
                        ...
                        <div class="d-flex flex-column text-light pe-0 pe-sm-10" >
                            <span id="displayErrors_paymentsmonth" class="mb-2  fw-bolder text-light"></span>
                        </div>
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        type="text" name="payments_month_val" id="payments_month_val" value="{{ $payments->payments_month_val }}"
