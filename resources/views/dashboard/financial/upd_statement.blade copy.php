                ...
                <div class="row p-0 mb-0 px-1">
                    ...
                    <div class="col">
                        <div class="border border-dashed border-dark text-center min-w-125px rounded pt-4 pb-2 my-3">
                            <span class="fs-6 fw-bold text-danger ">اسم المحل :</span> <span class=" fw-bold text-dark d-block">{{ $shop->shop_name}}</span> 																	<!--<span class="fs-6hx  text-gray-900 counted" data-kt-countup="true" data-kt-countup-value="36899">{{ session('Name') }}</span>-->
                        </div>
                    </div>
                    <div class="col">
                        <div class="border border-dashed border-dark text-center min-w-125px  rounded pt-4 pb-2 my-3">
                            <span class="fs-6 fw-bold text-danger ">شهر الدفع:</span> <span class=" fw-bold text-dark d-block">{{ $calculate->calculate_month_desc}}</span> 																	<!--<span class="fs-6hx  text-gray-900 counted" data-kt-countup="true" data-kt-countup-value="72">{{ session('user_id')}} </span>-->
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        data-inputmask="'alias' : 'decimal'" minlenght="1" maxlength="20" value="{{ $calculate->calculate_month_pay }}"
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        class="form-control fw-bold text-dark text-info" value="{{ $calculate->calculate_month_remain }}"
