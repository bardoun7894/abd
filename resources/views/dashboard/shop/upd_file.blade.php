                ...
                <div class="card-body ">
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5">
                            ...
                            .ai-extracted { background:#e9f7f0 !important; border-color:var(--sn-emerald) !important; transition:background .8s ease; }
                            select.ai-extracted + .select2 .select2-selection { background:#e9f7f0 !important; border-color:var(--sn-emerald) !important; }
                            ...
                            <div class="col-12 mb-4">
                                <div class="card ai-card">
                                    <div class="card-body py-4">
                                        ...
                                        <div class="ai-dropzone" id="ai_shop_document_dropzone" role="button" tabindex="0" aria-label="منطقة رفع مستند المحل — اسحب الملف هنا أو اضغط للاختيار">
