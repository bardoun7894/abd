                            ...
                            <div class="mb-5 row gx-5">
                                ...
                                (function(){
                                    ...
                                    function applyExtraction(d, st){
                                        ...
                                        st.appendChild(msg);
                                        if (d.nationality_name) {
                                            var nat = document.createElement('span'); nat.textContent = ' — الجنسية المقترحة: ' + d.nationality_name;
                                            st.appendChild(nat);
                                        }
                                    }
                                    ...
                                    btn.addEventListener('click', function(){
                                        ...
                                        fetch('{{ route('dashboard.ai_extract.start', ['module' => 'worker']) }}',{method:'POST',body:fd,headers:{'X-Requested-With':'XMLHttpRequest'}})
