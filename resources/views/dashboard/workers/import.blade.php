...
@section('content')
    ...
    <form id="save_imp" name="save_imp" class="form" action="{{ route('dashboard.workers.impfile') }}"
                        ...
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                <div class=" col-12 col-lg-12 col-md-12 col-sm-12 mb-5 ">
                                    <label for="uploadFile" class="form-label  fs-6 fw-bold text-dark mb-3">ملف :</label>
                                    <input class="form-control custom-file-input" type="file" name='uploadFile' id='uploadFile'>
                                </div>
                            </div>
                            <div class=" mb-2 d-flex justify-content ">
                                <button type="submit" id="kt_docs_formvalidation_text_submit"
                                    class="btn btn-primary font-weight-bold mr-2" name="submitButton">استيراد
                                    البيانات
                                </button>
                                &nbsp;&nbsp;
        ...
        <table class="table table-striped gy-7 gs-7">
            <thead>
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-800" style="background-color: #ffb822 !important;">
                    <th class="min-w-200px">رقم الاقامة</th>
                    <th class="min-w-400px">الاسم</th>
                    <th class="min-w-100px">الجنسية</th>
                    <th class="min-w-200px">المهنة</th>
                    <th class="min-w-200px">رقم الجواز</th>
                    <th class="min-w-200px">تاريخ انتهاء الجواز</th>
                    <th class="min-w-200px">تاريخ اصدار الاقامة</th>
                    <th class="min-w-200px">تاريخ انتهاء الاقامة</th>
                    <th class="min-w-200px">تاريخ الميلاد</th>
                    <th class="min-w-200px">خارج المملكه</th>
                    <th class="min-w-200px">تاريخ انتهاء الاقامة بالهجري</th>
                    <th class="min-w-200px">رقم صاحب العمل</th>
                </tr>
            </thead>
            <tbody>
                <tr>
