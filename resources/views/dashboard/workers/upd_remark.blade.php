...
<form id="upd_remark_data" name="upd_remark_data" class="form" action="{{ route('dashboard.workers.updremark') }}" method="post"
        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
            <div class="card">
                <div class="card-body ">
                    ...
                    <div class="mb-0" id=show_details></div>
...
@section('styles')
    ...
    <script>
view_all_reamrk("{{ route('dashboard.workers.tbl_remark') }}");
function del_remark(id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.workers.del_remark') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
