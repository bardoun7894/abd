...
<div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5">
    ...
    <div>
        <select class="form-select fw-bolder  shop_id" id="shop_id"
            ...
            <option
             @selected($moraslat->shop_id==$shop->shop_id) value="{{ $shop->shop_id }}">{{ $shop->shop_name}}</option>
...
<div class=" col-12 col-lg-12 col-md-12 col-sm-12  mb-5">
    <label for="moraslat_respon"
        class="  form-label fs-6 fw-bold text-dark mb-3">نص المعاملة</label>
    <textarea name="moraslat_respon" id="moraslat_respon">{{$moraslat->moraslat_respon}}</textarea>
</div>
