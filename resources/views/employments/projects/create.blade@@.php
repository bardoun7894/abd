                    ...
                    <div class="mb-0">
                     ...
                     <!--       <div class=" col-12 col-lg-5 col-md-12 col-sm-12  mb-5">
                         ...
                         <div class=" col-12 col-lg-6 col-md-12 col-sm-12  mb-5">
                            ...
                            <div class=" mb-5" style="border-top: 1px dashed #198754;"></div>
                            
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label class=" form-label fs-6 fw-bold text-dark mb-3">المحافظة المستهدفة </label>
                                <div>
<select class="form-select fw-bold" data-control="select2" name="PROJECT_AREA[]" id="PROJECT_AREA" dir="rtl" data-placeholder="المحافظة المستهدفة" data-allow-clear="true" multiple="multiple">
                             ...
                             <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                ...
                                <div>
                                    <select class="form-select fw-bold" data-control="select2" id="PROJECT_AREA_DEPT" name="PROJECT_AREA_DEPT[]"
                                        dir="rtl" data-placeholder="المنطقة" data-allow-clear="true" multiple="multiple">
                                        <option value="">اختر ..</option>
                         ...
                         <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label class=" form-label fs-6 fw-bold text-dark mb-3">المؤهل العملي</label>
                                <div>
                                    <select class="form-select fw-bold" data-control="select2" id="TYPE_IN" name="TYPE_IN"
                                        dir="rtl" data-placeholder="المؤهل العلمي">
                                        <option value="">اختر ..</option>
                         ...
                         <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div>
                                    <select class="form-select fw-bold" data-control="select2" id="SUB_TYPE_IN" name="SUB_TYPE_IN"
                                        dir="rtl" data-placeholder="التخصص">
                                        <option value="">اختر ..</option>
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12   mb-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="SALARY_IN" id="SALARY_IN" class="form-control "
                                        placeholder="الراتب" />
                                </div>
                            </div>
                         ...
                         <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label class=" form-label fs-6 fw-bold text-dark mb-3">العملة</label>
                                <div>
                                    <select class="form-select fw-bold" data-control="select2" id="CURRENCY_SALARY_IN" name="CURRENCY_SALARY_IN"
                                        dir="rtl" data-placeholder="العملة">
                                        <option value="">اختر ..</option>
                                        @foreach ($coins as $x)
                                                        <option value="{{ $x->status_id }} ">{{ $x->status_name}}</option>
                            ...
                            <div class=" mb-5" style="border-top: 1px dashed #198754;"></div>
                             ...
                             <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                ...
                                <div>
<select class="form-select fw-bold" data-control="select2" name="SIDE_ID_IN[]" id="SIDE_ID_IN" dir="rtl" data-placeholder="جهات التشغيل" data-allow-clear="true" multiple="multiple">
                                        <option value="">اختر ..</option>
                                        @foreach ($CONT_TYPE_ID as $x)
                                    <option value="{{ $x->cont_id }} ">{{ $x->cont_name}}</option>
                                        @endforeach
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12   mb-5">
                                <label for="EMPLOYMENT_PROJECTS_USER_COUNT" class="form-label fs-6 fw-bold text-dark mb-3">عد المستفدين من
                                    المشروع</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="fas fa-stopwatch-20 fa-fw text-dark"></i></span></div>

                                    <input type="number" name="BENEFICIARY_COUNT_IN" id="BENEFICIARY_COUNT_IN " class="form-control "
                         ...
                         <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label class=" form-label fs-6 fw-bold text-dark mb-3">المؤهل العملي</label>
                                <div>
                                    <select class="form-select fw-bold" data-control="select2" id="BENEFICIARY_TYPE_IN" name="BENEFICIARY_TYPE_IN"
                                        dir="rtl" data-placeholder="المؤهل العلمي">
                                        <option value="">اختر ..</option>
                                        @foreach ($type_in as $x)
                                                        <option value="{{ $x->status_id }} ">{{ $x->status_name}}</option>
                            ...
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label class=" form-label fs-6 fw-bold text-dark mb-3">المحافظة المستهدفة </label>
                                <div>
<select class="form-select fw-bold" data-control="select2" name="BENEFICIARY_REGION_IN" id="BENEFICIARY_REGION_IN" dir="rtl" data-placeholder="المحافظة المستهدفة" data-allow-clear="true">
                                        ...
                                        @endforeach
                                                        ...
                                                        <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label class=" form-label fs-6 fw-bold text-dark mb-3">جنس المستهدفين</label>
                                <div>
<select class="form-select fw-bold" data-control="select2" name="BENEFICIARY_GENDER_IN" id="BENEFICIARY_GENDER_IN" dir="rtl" data-placeholder="المحافظة المستهدفة" data-allow-clear="true" >
...
<div id="kt_docs_repeater_advanced">
       ...
       <div class="col-12 col-lg-2 col-md-12 col-sm-12   mb-5">
                         ...
                         <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div>
                                                                ...
                                                                <select class="form-select " data-kt-repeater="select2"  data-placeholder="Select an option" id="PRsssOJECT_AREA" name="PRsssOJECT_AREA">
                                        <option value="">اختر ..</option>
                                        @foreach ($type_in as $x)
                                                        <option value="{{ $x->status_id }} ">{{ $x->status_name}}</option>
                                        @endforeach
    ...
    <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label class=" form-label fs-6 fw-bold text-dark mb-3">جنس المستهدفين</label>
                                <div>
<select class="form-select fw-bold " data-control="select2" name="other_participant[1][name]"  dir="rtl" data-placeholder="المحافظة المستهدفة" data-allow-clear="true" >
    ...
    <!--begin::Form group-->
    <div class="form-group">
        <a href="javascript:;" id="repeater-button" data-repeater-create class="btn btn-flex btn-light-primary">
...
<!--	<script src="{{ asset('assets/js/custom/documentation/forms/advanced.js') }}"></script>-->
