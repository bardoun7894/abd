...
@once
<style>
.ai-insight-card{position:relative;border:0;border-radius:1rem;overflow:hidden;box-shadow:0 .5rem 1.5rem rgba(20,119,174,.15);}
.ai-insight-card__header{position:relative;padding:1.5rem 1.75rem;background:linear-gradient(135deg,var(--sn-emerald) 0%,var(--sn-emerald-deep) 100%);color:#fff;overflow:hidden;}
