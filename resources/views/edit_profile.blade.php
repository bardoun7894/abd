...
@section('content')
    ...
    <form id="update_profile" name="update_profile" class="form" action="{{ route('updateProfile') }}"
                    ...
                    <div class="row p-0 mb-0 px-1">
                        <div class="col">
                            <div class="border border-dashed border-dark text-center min-w-125px rounded pt-4 pb-2 my-3">
                                <span class="fs-6 fw-bold text-info ">اسم الموظف :</span> <span class=" fw-bold text-success d-block">{{ $emps->name }}</span>
                            </div>
                        </div>
                        <div class="col">
                            <div class="border border-dashed border-dark text-center min-w-125px  rounded pt-4 pb-2 my-3">
                                <span class="fs-6 fw-bold text-info ">المسمى الوظيفي:</span> <span class=" fw-bold text-success d-block">{{ $emps->j_c_name_ar }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-1">
                        <div class="separator separator-content border-dark my-5 mb-10"><span class="w-150px fw-bold text-danger">بيانات الشخصية</span></div>
                        ...
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                    <label for="password_confirmation" class="form-label required fs-6 fw-bold text-dark mb-3">تأكيد كلمة المرور</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                            type="password" name="password_confirmation" id="password"
                                            class="form-control fw-bold  text-info" placeholder="تأكيد كلمة المرور ">
                                    </div>
                                </div>
                            </div>
