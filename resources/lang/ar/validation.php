...
return [
    ...
    'custom' => [
        'title' => [
            'required' => 'عنوان الجدول مطلوب',
            'max' => 'عنوان الجدول يجب أن لا يتجاوز :max حرف'
        ],
        'start_date' => [
            'required' => 'تاريخ البداية مطلوب',
            'date' => 'تاريخ البداية يجب أن يكون تاريخاً صحيحاً'
        ],
        'end_date' => [
        ...
        'registration_number' => [
            ...
            'unique' => 'رقم الاشتراك مستخدم مسبقاً',
            'max' => 'رقم الاشتراك يجب أن لا يتجاوز :max حرف'
        ],
    ],
];
